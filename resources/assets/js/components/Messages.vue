    ...
    export default {
        ...
        mounted() {
            ...
            axios.get('/api/users').then((response) => {
                ...
                if (this.users.length > 0) {
                    ...
                    axios.get('/api/messages/with/' + this.users[0].id)
                        .then((response) => {
                            // console.log(response);
            ...
            axios.get('/api/me').then((response) => {
                ...
                Echo.channel('private-user.' + this.me.id)
        ...
        methods: {
            submitMessage(e) {
                ...
                axios.post('/api/messages/to/' + this.selected, {
                    text: this.text
                }).then((response) => {
                    // console.log(response);
                    this.text = ''
            ...
            changeSelected(e) {
                ...
                axios.get('/api/messages/with/' + this.selected)
                    .then((response) => {
                        // console.log(response);
                        this.messages = response.data;
                    })
